...
function ProjectDashboard() {
  ...
  const handleDownloadReport = async () => {
    try {
      setIsLoading(true);
      const response = await fetch('https://10cb-2409-40c1-100b-7ec-4d18-b73f-99d0-de1a.ngrok-free.app/report', {
        method: 'GET',
        headers: {
  ...
  const handleSystemTest = async () => {
    try {
      ...
      const response = await fetch('https://10cb-2409-40c1-100b-7ec-4d18-b73f-99d0-de1a.ngrok-free.app/test-status', {
        method: 'POST',
        headers: {
            'ngrok-skip-browser-warning': 'true',
            'Content-Type': 'application/json'
